...
gEngine.Textures = (function ()
{
    ...
    var unloadTexture = function (textureName) {
        ...
        var textInfo = gEngine.ResourceMap.retriveAsset(textureName);
        gl.deleteTexture(textInfo.mGLTexID);
    ...
    var activateTexture = function (textureName) {
        var gl = gEngine.Core.getGL();
        var texInfo = gEngine.ResourceMap.retriveAsset(textureName);
    ...
    var getTextureInfo = function (textureName) {
        return gEngine.ResourceMap.retriveAsset(textureName);
    };
    var mPublic = {
