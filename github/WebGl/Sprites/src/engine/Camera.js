...
Camera.prototype.getPoint=function(e)
{
    var canvas= gEngine.Core.getCanvas();
    var rect = canvas.getBoundingClientRect();
    return {x: e.clientX - rect.left, y: e.clientY - rect.top};
};
Camera.prototype.get2DPos=function(pos,width,height)
{
    var x= 2.0 * pos.x/width;
    var y= 2.0 * pos.y/height;
    var inv=mat4.create();
    mat4.inverse(inv,this.mVPMatrix);
    var point3= vec3.fromValues(x,y);
    mat4.mul(inv,inv,point3);
    return inv;
};
